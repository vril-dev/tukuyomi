...
func StatusHandler(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"response_cache_stale_seconds":          responseCache.StaleSeconds,
		"response_cache_refresh_timeout_sec":    responseCache.RefreshTimeout,
		"response_cache_refresh_backoff_sec":    responseCache.RefreshBackoff,
		"response_cache_store_shape":            responseCache.StoreShape,
		"response_cache_store_path":             responseCache.StorePath,
		"response_cache_disk_bytes":             responseCache.DiskBytes,
		...
		"response_cache_stale_hits":             responseCache.StaleHits,
		"response_cache_stale_refreshes":        responseCache.StaleRefreshes,
		"response_cache_stale_failures":         responseCache.StaleFailures,
		"response_cache_backoff_skips":          responseCache.BackoffSkips,
