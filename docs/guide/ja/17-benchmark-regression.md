...
### 17.1.8　Hot Path Logging と Profile Capture
...
## 17.3　Release-binary smoke ── 公開配布物そのものを確認する
...
### 17.3.1　`make deployment-smoke` との違い
...
第VII部もあと 1 章です。次の第18章では、**static fast-path 評価** ── 静的
