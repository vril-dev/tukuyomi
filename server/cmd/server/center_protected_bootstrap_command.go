...
func runBootstrapCenterProtectedGatewayCommand(args []string) {
	...
	gatewayAPIBasePath := fs.String("gateway-api-base-path", "", "Gateway/device Center API base path")
	centerAPIBasePath := fs.String("center-api-base-path", "", "Center management API base path")
