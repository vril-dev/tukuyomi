...
SELECT device_id, bundle_revision, bundle_hash, compressed_size_bytes, uncompressed_size_bytes, file_count, created_at_unix, created_at
...
INSERT INTO center_rule_artifact_bundles
    (device_id, bundle_revision, bundle_hash, compressed_size_bytes, uncompressed_size_bytes, file_count, created_at_unix, created_at)
VALUES
