...
ALTER TABLE edge_device_identities ADD COLUMN config_snapshot_pushed_at_unix INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE center_devices ADD COLUMN config_snapshot_at_unix INTEGER NOT NULL DEFAULT 0;
ALTER TABLE center_devices ADD COLUMN config_snapshot_bytes INTEGER NOT NULL DEFAULT 0;
