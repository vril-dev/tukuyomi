...
func MetricsHandler(c *gin.Context) {
	...
	writePromGauge(&b, "tukuyomi_server_http2_enabled", boolGauge(config.ServerHTTP2Enabled))
	writePromGauge(&b, "tukuyomi_server_http2_advertised", boolGauge(http2Status.Advertised))
