...
const JA_STRINGS: Record<string, string> = {
  ...
  "base WAF load order": "base WAF 読み込み順",
  "Coraza and base WAF load order": "Coraza と base WAF 読み込み順",
  "path overrides": "パス例外",
  ...
  "startup config, operator identity, verify manifest":
    "startup 設定、操作主体、verify manifest",
  "account, password, tokens": "アカウント、パスワード、トークン",
  ...
  "Security Control Overview ({hours}h)":
    "セキュリティ制御概要（{hours}時間）",
  ...
  "Active Controls (24h)": "有効化された制御（24時間）",
  "Active Controls ({hours}h)": "有効化された制御（{hours}時間）",
  "Scan coverage: {start} - {end}": "走査範囲: {start} - {end}",
  "Top Blocks (24h)": "上位ブロック（24時間）",
  "Top Blocks ({hours}h)": "上位ブロック（{hours}時間）",
  "Top Blocked Paths (24h)": "上位ブロックパス（24時間）",
  "Top Blocked Paths ({hours}h)": "上位ブロックパス（{hours}時間）",
  "Top Blocked Countries (24h)": "上位ブロック国コード（24時間）",
  "Top Blocked Countries ({hours}h)":
    "上位ブロック国コード（{hours}時間）",
  "WAF Rule IDs (24h)": "WAF Rule ID（24時間）",
  "WAF Blocks (24h)": "WAFブロック数（24時間）",
  "WAF Blocks (In Scan Window)": "WAFブロック数（走査期間）",
  "Top Rule IDs (24h)": "上位 Rule ID（24時間）",
  "Top Paths (24h)": "上位パス（24時間）",
  "Top Countries (24h)": "上位国コード（24時間）",
  "Updating security stats...": "セキュリティ統計を更新しています...",
  "Failed to load security stats: {error}":
    "セキュリティ統計の読み込みに失敗しました: {error}",
  ...
  "Blocked Requests by Control": "制御別ブロック数",
  ...
  "Base rule": "ベースルール",
  "Bypass rule": "Bypass rule",
  "Enable on save": "保存時に有効化",
  "Base WAF rule set": "ベースWAFルールセット",
  "Base WAF rules": "ベースWAFルール",
  "Coraza CRS rules": "Coraza CRSルール",
  "Coraza CRS setup": "Coraza CRS setup",
  "Coraza CRS rule": "Coraza CRS rule",
  "Bypass rule snippet": "Bypass rule snippet",
  "Bypass snippets": "Bypass snippets",
  Advanced: "Advanced",
  "Runtime WAF rules": "Runtime WAF rules",
  "Enable all CRS": "CRS を全て有効化",
  "Disable all CRS": "CRS を全て無効化",
  "Save CRS": "CRS を保存",
  setup: "setup",
  Loaded: "読み込み済み",
  "CRS setup": "CRS setup",
  "Add base rule asset": "ベースルールアセットを追加",
  "Add bypass snippet": "Bypass snippet を追加",
  "Manage base WAF rule assets in runtime load order.":
    "base WAF rule asset を runtime 読み込み順で管理します。",
  "Manage Coraza CRS and base WAF rule assets in runtime load order.":
    "Coraza CRS と base WAF rule asset を runtime 読み込み順で管理します。",
  Usage: "用途",
  "Referenced by": "参照元",
  "Not referenced": "未参照",
  "{count} refs": "{count} 件参照",
  ...
  "No bypass snippets configured.": "Bypass snippet は設定されていません。",
  Lines: "行数",
  Chars: "文字数",
  Unvalidated: "未検証",
  Valid: "有効",
  ...
  "Start time": "開始日時",
  "End time": "終了日時",
  "path, rule_id, host, message": "path, rule_id, host, message",
  req_id: "req_id",
  "req-...": "req-...",
  ...
  "Loading user...": "ユーザー情報を読み込んでいます...",
  "Password change required": "パスワード変更が必要",
  "Change the initial password before continuing.":
    "続行する前に初期パスワードを変更してください。",
  user: "user",
  role: "role",
  Account: "アカウント",
  "Login Identity": "ログイン ID",
  Username: "ユーザー名",
  "Username is required.": "ユーザー名を入力してください。",
  Email: "メールアドレス",
  "Current password": "現在のパスワード",
  "Confirm password to save account changes":
    "アカウント変更を保存するため現在のパスワードを入力",
  "Required to save account changes.":
    "アカウント変更の保存に必要です。",
  "Enter your current password to save account changes.":
    "アカウント変更を保存するには現在のパスワードを入力してください。",
  "Saving account changes...": "アカウント変更を保存しています...",
  "Save Account": "アカウントを保存",
  "Account saved.": "アカウントを保存しました。",
  "Admin login identity updated.": "admin ログイン ID を更新しました。",
  "New password": "新しいパスワード",
  "New password (12+ characters)": "新しいパスワード（12文字以上）",
  "12 characters minimum.": "12文字以上で入力してください。",
  "Enter your current password to change password.":
    "パスワードを変更するには現在のパスワードを入力してください。",
  ...
  "Confirm password to create token":
    "トークン作成のため現在のパスワードを入力",
  "Required to create a token.": "トークン作成に必要です。",
  "Enter your current password to create a token.":
    "トークンを作成するには現在のパスワードを入力してください。",
  "Creating...": "作成中...",
  "Creating token...": "トークンを作成しています...",
  "Create Token": "トークンを作成",
  "Personal access token created.": "Personal Access Token を作成しました。",
  "Revoking token...": "トークンを revoke しています...",
  "Personal access token revoked.": "Personal Access Token を revoke しました。",
  ...
  "Persistent File Storage": "永続ファイルストレージ",
  "Durable runtime files such as ACME account keys and certificates. Provider credentials are read from environment or platform identity, not saved here.":
    "ACME account key や証明書などの永続 runtime file です。provider 認証情報は environment または platform identity から読み、ここには保存しません。",
  Backend: "backend",
  Local: "ローカル",
  S3: "S3",
  ...
  "Persistent Storage S3 Prefix": "永続 storage S3 prefix",
  "Persistent Storage S3 Path Style": "永続 storage S3 path-style",
  "S3 Bucket": "S3 bucket",
  "S3 Region": "S3 region",
  ...
  "Adaptive shrinking": "adaptive 縮小",
  ...
  "Semantic scoring": "セマンティックスコアリング",
  Entries: "エントリ数",
  Entry: "エントリ",
  ...
  Modules: "モジュール",
  "{count} default off": "{count} 件 default off",
  "{count} installed": "{count} 件インストール済み",
  "default off": "default off",
  "No built modules detected.": "build 済み module は検出されていません。",
  "Open Runtime": "Runtime を開く",
  PID: "PID",
  "PHP runtime action failed.": "PHP runtime 操作に失敗しました。",
  "PHP runtime {runtime} reloaded.": "PHP runtime {runtime} を reload しました。",
  "PHP runtime {runtime} started.": "PHP runtime {runtime} を起動しました。",
  "PHP runtime {runtime} stopped.": "PHP runtime {runtime} を停止しました。",
  Reload: "再読み込み",
  "Runtime State": "Runtime 状態",
  "Runtime entries are managed here for visibility, readiness, and PHP-FPM process controls.":
    "ここでは runtime の可視化、readiness、PHP-FPM process 操作を扱います。",
  Start: "起動",
  "Started At": "起動時刻",
  Stop: "停止",
  "Stopped At": "停止時刻",
  ...
  inherit: "継承",
  exited: "異常終了",
  identity_error: "identity エラー",
  manual_stopped: "手動停止",
  not_materialized: "未生成",
  preflight_failed: "事前検証失敗",
  reconcile_error: "reconcile エラー",
