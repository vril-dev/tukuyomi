...
const JA_STRINGS: Record<string, string> = {
  ...
  "Runtime assignments": "ランタイム割り当て",
  "Desired runtime artifacts assigned from Center.": "Center から割り当てた期待ランタイム artifact です。",
  ...
  "Failed to clear runtime assignment": "ランタイム割り当ての解除に失敗しました",
  ...
  Clear: "解除",
  "Clearing...": "解除中...",
  "No runtime assignments.": "ランタイム割り当てはありません。",
